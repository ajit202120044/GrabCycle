...
import com.grabcycles.library.dto.CategoryDto;
...
public interface CategoryRepository extends JpaRepository<Category, Long> {
    ...
    /*Customer*/
    @Query("select new com.grabcycles.library.dto.CategoryDto(c.id, c.name, count(p.category.id)) from Category c inner join Product p on p.category.id = c.id " +
